<?
	...
	{
		$event_folder = $_SESSION['event_folder'];
		$start_date = substr($event_folder,0,8);
		$id = substr($event_folder,8);	
		$event = mysql_fetch_array(mysql_query("SELECT * FROM events WHERE id=$id"));
	}
	...
	if (!$_SESSION['photos'][0])
	{
		...
		header("Location:../../../rental/events/photos/".$event_folder);
		...
		<table width="100%" height="100%">
			<tr>
				<td align="center" valign="middle">
					...
					<?
					/*
					<img src="https://www.myphotocode.com/assets/images/uploading.gif" width="220" height="19" />
					<br /><br />
					*/
					?>
					<span style="font-family:Georgia;font-style:italic;font-size:18px;"><? echo count($_SESSION['photos']); ?> photos left</span>
...
<?
	...
	$post_login_url = "https://www.myphotocode.com/assets/php/templates/facebook-album-uploader.php";
	...
	else
	{
		...
		//echo "UPLOAD: ".$_SESSION['photos'][0]."<br />";
		$photoUrl = "../../../events/".$event_folder."/".$_SESSION['photos'][0].".jpg";
		...
		$graph_url= "https://graph.facebook.com/me/photos?access_token=" .$access_token;
		    ...
		    if(is_array($decoded) && isset($decoded['id'])) {
				...
				array_shift($_SESSION['photos']);
				
				//for ($x = 0; $x < count($_SESSION['photos']); $x++) echo $x." : ".$_SESSION['photos'][$x]."<br />";
				echo("<script>top.location.href='facebook-album-uploader.php';</script>");
