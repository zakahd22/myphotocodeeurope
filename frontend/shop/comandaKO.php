    ...
    <body>
        ...
        <div class='blok blokWhite'>  
            <div class='imgContainer' style='border: 0px;'>
                <?php echo "<img  src='images/error_shop.gif' style='width:50%;margin-left:25%;margin-top:2%;'>"; ?>
            </div>
            <div  class='contentDiv'>
                <h2> Ha habido un error a la Hora de pagar....</h2>
            ...
            <div style='width:80%;display:inline;float:left;margin-left:10%;margin-top:30px;border-top: 3px solid gray;'>
                <?php
                ...
                while ($CLD_CON->FetchArray()) {
                    ...
                    echo "<a href='./shop.php?p=$id_p&code=$code_p' style='z-index: 10;'><img class='imgProduct' src='$image'>";
