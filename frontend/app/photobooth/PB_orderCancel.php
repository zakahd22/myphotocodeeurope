...
$sql = "UPDATE App_PBorders SET `fpagstatus`=3 WHERE idOrder = $idOrder AND `fpagcontrol` = '$fpagcontrol' AND `fpagstatus`<3;";
$esOK = $APP_BdD->Execute($sql);
if(!$esOK) {
    echo "ko#error pp02b $sql";
 return;
}

//ara mirem en quin estat està
