...
if(!$esOK){
//caldria controlar l'error
echo "$APP_xml<comm_status>Error Database error code: 0003 $sql</comm_status></return>";
return;
}
$dateReport = "";
if($APP_BdD->FetchRs()){
...
//20120919    $xml.= "<software/><dateReport/>";
    $xml.= "<software></software><dateReport></dateReport>";//20120919
...
if(!$esOK){
//caldria controlar l'error
echo "$APP_xml<comm_status>Error Database error code: 0004 $sql</comm_status></return>";
return;
}
$dateCheck = "";
if($APP_BdD->FetchRs()){
...
if(!$esOK){
//caldria controlar l'error
echo "$APP_xml<comm_status>Error Database error code: 0005 $sql</comm_status></return>";
return;
}
if($APP_BdD->FetchRs()){
    $tmp =  $APP_BdD->GetField(1);
...
if(!$esOK){
//caldria controlar l'error
echo "$APP_xml<comm_status>Error Database error code: 0005b $sql</comm_status></return>";
return;
}
if($APP_BdD->FetchRs()){
    $tmp =  $APP_BdD->GetField(1);
...
if(!$esOK){
//caldria controlar l'error
echo "$APP_xml<comm_status>Error Database error code: 0006 $sql</comm_status></return>";
return;
}
if($APP_BdD->FetchRs()){
    $tmp =  $APP_BdD->GetField(1);
...
if(!$esOK){
//caldria controlar l'error
echo "$APP_xml<comm_status>Error Database error code: 0007 $sql</comm_status></return>";
return;
}
if($APP_BdD->FetchRs()){
    $tmp =  $APP_BdD->GetField(1);
...
if(!$esOK){
//caldria controlar l'error
echo "$APP_xml<comm_status>Error Database error code: 0008 $sql</comm_status></return>";
return;
}
if($APP_BdD->FetchRs()){
    $tmp =  $APP_BdD->GetField(1);
...
if(!$esOK){
//caldria controlar l'error
echo "$APP_xml<comm_status>Error Database error code: 0009 $sql</comm_status></return>";
return;
}
if($APP_BdD->FetchRs()){
    $tmp =  $APP_BdD->GetField(1);
...
if(!$esOK){
//caldria controlar l'error
echo "$APP_xml<comm_status>Error Database error code: 0010 $sql</comm_status></return>";
return;
}
$xml.= "<products>"; 
//    $xml.= "<trace>$sql</trace>";
...
//return;
    ...
    if(!$esOK){
    //caldria controlar l'error
    echo "$APP_xml<comm_status>Error Database error code: 0010b $sql</comm_status></return>";
    return;
    }
    if($APP_BdD->FetchRs()){
        $tmp =  $APP_BdD->GetField(1);
    ...
    if(!$esOK){
    //caldria controlar l'error
    echo "$APP_xml<comm_status>Error Database error code: 0010c $sql</comm_status></return>";
    return;
    }
    $xml.= "<session_stock>";
    if($APP_BdD->FetchRs()){
...
if(!$esOK){
//caldria controlar l'error
echo "$APP_xml<comm_status>Error Database error code: 0012 $sql</comm_status></return>";
return;
}
$xml.= "<reports>"; 
//    $xml.= "<trace>$sql</trace>";
