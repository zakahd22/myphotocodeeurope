...
//        var_dump($igUser);exit;
        ...
        //si canvia la peticio de username a hashtag a dalt fem update perque AllPhotosServed=0
      ...
      $urlsArray = getNextPhotos($word, $filename, $token, $type, $numFrom , $photos_number, $photos_number, $other, 1); 
      $urls = $urlsArray['urls'];
        ...
        if(isset($urls) && $urls != "" ){
            ...
            if($urlsDownloaded==''){ //si està en blanc no tenim res descarregat anteriorment i la crida ha fallat (tampoc ha descarregat res nou)
                ...
                $result = "OK#0"; 
                    ...
                    $urlsArray = getNextPhotos($word, $filename, $token, $type, $numFrom , $photos_number, $photos_number, $other, 0); 
