...
## Demo
[Demo File Upload](https://blueimp.github.com/jQuery-File-Upload/)
...
* [jQuery UI widget factory](https://wiki.jqueryui.com/w/page/12138135/Widget%20factory) v. 1.8.16+
...
* [JavaScript Load Image function](https://blueimp.github.com/JavaScript-Load-Image) v. 1.1.3+ (optional)
...
The repository also includes the [jQuery XDomainRequest Transport Plugin](https://github.com/blueimp/jQuery-File-Upload/blob/master/cors/jquery.xdr-transport.js), which is required for Cross-domain AJAX requests in Microsoft Internet Explorer >= 8. It is only included for the [Demo](https://blueimp.github.com/jQuery-File-Upload/), which makes use of Cross-domain DELETE requests (GET requests for IE) to delete uploaded files from the Demo File Upload service.
