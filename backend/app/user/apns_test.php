...
//
//if(isset($_REQUEST['badge'])){ $numBadge = $_REQUEST['badge']; $toXml.= "<TRACE>badge $numBadge</TRACE>";} else {$numBadge = -1;} 
//
//if(isset($_REQUEST['acme1'])){ $Acme1 = $_REQUEST['acme1']; $toXml.= "<TRACE>acme1 $Acme1</TRACE>";  } else {$Acme1 = "";}
//
//if(isset($_REQUEST['acme2'])){ $Acme2 = $_REQUEST['acme2']; $toXml.= "<TRACE>acme2 $Acme2</TRACE>";} else {$Acme2 = "";}
//
//$APNS_MessageAdded = APNS_newAlertTestUser($APP_userId,$text,$numBadge, $Acme1, $Acme2);
//
