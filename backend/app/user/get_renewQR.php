...
$url =  APP_curPageURL();
//20131028  $xml.= "<user><userqr>{$url}userqr/qr$APP_userId.png</userqr></user>";
$xml.= "<user><userqr>{$url}userqr/qr$codi.png</userqr></user>";//20131028
...
echo "$APP_xml$APP_xmlOKcomm$xml</return>";
?>
