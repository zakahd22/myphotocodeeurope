...
if($startDate){ $sqlStartDate = "AND datetimeS = '$startDate'";}
if($finishDate){ $sqlfinishDate = "AND datetimeF = '$finishDate'";}

$result = "Error";

$sql = "DELETE FROM App_boothDongle WHERE idBooth = {$idBooth} AND idDongle = {$idDongle} {$sqlStartDate} {$sqlfinishDate}";
