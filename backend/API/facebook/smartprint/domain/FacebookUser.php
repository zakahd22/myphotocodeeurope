...
class FacebookUser
{
    ...
    private function __construct($token, $fb_access_token, $total_photos, $num_photos, $last_downloaded_photos, $all_photos_served, $last_photo, $idBooth, $game_code)
    {
        $this->token = $token;
    ...
    public static function of($token, $fb_access_token, $total_photos, $num_photos, $last_downloaded_photos, $all_photos_served, $last_photo, $idBooth, $game_code) {
        return new static($token, $fb_access_token, $total_photos, $num_photos, $last_downloaded_photos, $all_photos_served, $last_photo, $idBooth, $game_code);
    }
