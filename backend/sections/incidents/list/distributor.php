...
//    $CLD_CON->OpenRs("SELECT * FROM CLD_Incidents ORDER BY status , datetime DESC");
}
...
foreach ($incidents as $incident){
    ...
    if($disID == $_SESSION['USERID']){
        ...
        $html .= "<input type='button' style='margin-top:2px;' class='miniComents' onclick='openCloseComents(\"com$id\")' title='LOOK/UNLOOK COMMENTS'>";
        $html .= "</span></p>";
        $html .= "</div>";
    }
}
