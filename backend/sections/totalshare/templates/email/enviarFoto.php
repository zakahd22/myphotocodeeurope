...
$message = <<< HTML
    ...
    <body>
        ...
        <p style='font-size:18px;'>Click on the link to see your photo <a https://www.myphotocode.com/index.php?code=$code&method=email&v=4" target="_blank">$code</a></p>
        <p style='font-size:18px;'>$txt2</p> 

        <p style='font-size:12px;'>
        <br/>
<p style='font-size:18px;'> If your email client can't open HTML links, you can copy the following code in a browser to see your picture: https://www.myphotocode.com/index.php?code=$code&method=email&v=4 </p> 
<br/>
