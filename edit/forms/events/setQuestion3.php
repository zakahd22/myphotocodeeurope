<?php
$CLD_CON->OpenRs("SELECT id , question , reply1 , reply2 FROM CLD_questions WHERE question_number=3 AND event=$ID");
...
if ($CLD_CON->FetchArray()) {
    ...
    $btn = "<input type='button' class='popup-confirm' value='Turn OFF' style='background-color:#dd6b55;' onclick='OnOffQuestion3($ID , 0); hidePopupv2();'>";
    ...
    $reply2 = "";
    $disabled = "";
    $btn = "<input type='button' class='popup-confirm' value='Turn ON' onclick='OnOffQuestion3($ID , 1); hidePopupv2();'>";
    $btn .= "<input type='button' class='popup-cancel' value='Cancel' onclick='hidePopupv2();'>";
}
...
$content .= <<<HTML
<script>
    function OnOffQuestion3(id , active){
        var q = $("#qTxt").val();
        var rp1 = $("#r1").val();
        var rp2 = $("#r2").val();
        var ajaxData = {id : id , question : 3 , active : active , r1 : rp1 , r2 : rp2 , q : q}; 
