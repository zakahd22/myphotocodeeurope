...
//        }
    ...
    private function getOwnerPBs($idOwner, $serialNumber = "") {
        ...
        $pbs_array = $this->App_boothsModel->getPbsListFilterAuditsSuperWithDongle($serialNumber, FALSE, FALSE, FALSE, FALSE,$idOwner);
...
//                }
                ...
                $info_text = <<<HTML
                        ...
                        <div id="idOwner" class="hidden">{$this->idUser}</div>
...
//                utils::log("minVersion = {$minPBversion}", 'logAleix');
                ...
                if($idPb){
                    ...
                    $collection_label = "<td class='no-color td-small'></td><td class='rotate'><div><span>Collection</div></span></td>";
                }
...
//               $stock_empty .= "<td class='borderRight'>-</td>";
                ...
                $collection_empty   .= "<td class='no-color td-small'></td><td>0</td>";
                $collection_unknown .= "<td class='no-color td-small'></td><td>-</td>";
            }
...
//                                utils::log('TRACE 0', 'logAleix');
                            ...
                            $collection_rows = "<td class='no-color td-small'></td><td>{$collectionNum}</td>";                                
                        }
